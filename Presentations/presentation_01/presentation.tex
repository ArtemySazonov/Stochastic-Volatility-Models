...
\begin{document}
    ...
    \section*{Conclusion}
        ...
        \begin{frame}{Bibliography}
            \begin{itemize}
                \item Steven L. Heston -- A Closed-Form Solution for Options with Stochastic Volatility with Applications to Bond and Currency Options, \href{https://www.sciencedirect.com/science/article/pii/S0304405X00000756}{\textit{Review of Financial Studies}}, 1993.
                \item 
            \end{itemize}
        \end{frame}
\end{document}
